      ...
      >
        <div className="bg-white/80 backdrop-blur-sm border border-emerald-100 rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Join NutriSight</h1>
            <p className="text-gray-600">Begin your intelligent health journey</p>
          </div>
          ...
          {magicLinkSent && (
            ...
            >
              ...
              <p className="text-sm mt-1">Check your email and click the link to complete your registration.</p>
            </motion.div>
          )}
