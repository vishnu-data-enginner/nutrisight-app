...
const CompleteUpgradedHomepage: React.FC = () => {
  const stats = [
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Stats Section */}
      <section className="py-20 bg-gradient-to-r from-emerald-50 to-teal-50 relative overflow-hidden z-10">
        {/* Background Elements */}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-lg border border-white/20 text-center"
              >
...
export default CompleteUpgradedHomepage
